...
def predict1():
    ...
    prediction = model.predict([[age,sex,cp,trestbps,fbs,restecg,thalach,exang,oldpeak,slope,ca,thal]])
    if prediction==0:
...
def predict2():
    ...
    return render_template('logistic.html', prediction_text='message')
